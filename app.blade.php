    ...
    <div class="container">
      <div class="topbar">
        ...
        <div class="right">
          ...
          <a href="{{route('korzinka',$l)}}" class="cart">
      ...
      <div class="container d-flex justify-content-center align-items-center">
        ...
        <div class="nav-wrapper">
          <nav>
            ...
            <ul class="nav-links">
              <li>
                <a class="menu" href="{{route('home',['l'=>$l,'type'=>'tosell'])}}">Products</a>
              </li>
              <li>
                <a class="menu" href="{{route('home',['l'=>$l,'type'=>'tolend'])}}">Renting</a>
              </li>
              <li>
...
<footer>
  <div class="container">
    <div class="wrapper">
      ...
      <div class="center">
        <a href="{{route('home',['l'=>$l,'type'=>'tolend'])}}">Products</a>
        <a href="{{route('home',['l'=>$l,'type'=>'tosell'])}}">Renting</a>
        <a href="#">About us</a>
        <a href="#">Contact</a>
      </div>
      <div class="right">
