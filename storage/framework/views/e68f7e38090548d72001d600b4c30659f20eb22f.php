...
<?php $__env->startSection('content'); ?>
 <main class="item-list">
        <div class="items">
            <form action="">
            ...
            </form> <a href="#" class="item">
                <div class="img"> <img src="<?php echo e(asset('assets/basketball.b654791b.jpg')); ?>" alt=""> <span>от 120 000 UZS</span> </div>
                <div class="content">
                    <div>
                        <h6>Настольный теннис на 1905 года</h6> <span> <img src="<?php echo e(asset('assets/location.19cb9090.svg')); ?>" alt="location" title="Icon made by Freepik from www.flaticon.com"> ЦАО, улица 1905 года, 7с </span> <span> <img src="<?php echo e(asset('assets/football-field.2f934f7f.svg')); ?>" alt="sport field" title="Icon made by Freepik from www.flaticon.com"> Терафлекс </span> <span> <img src="<?php echo e(asset('assets/metro.29e1953a.svg')); ?>" alt="metro" title="Icon made by Freepik from www.flaticon.com"> Улица 1905 года </span>
                    </div>
                    <div class="new">
                        <div>new</div>
                    </div>
                ...
                <div class="img"> <img src="<?php echo e(asset('assets/pitch.78265cba.jpg')); ?>" alt=""> <span>от 120 000 UZS</span> </div>
                <div class="content">
                    <div>
                        <h6>Настольный теннис на 1905 года</h6> <span> <img src="<?php echo e(asset('assets/location.19cb9090.svg')); ?>" alt="location" title="Icon made by Freepik from www.flaticon.com"> ЦАО, улица 1905 года, 7с </span> <span> <img src="<?php echo e(asset('assets/football-field.2f934f7f.svg')); ?>" alt="sport field" title="Icon made by Freepik from www.flaticon.com"> Терафлекс </span> <span> <img src="<?php echo e(asset('assets/metro.29e1953a.svg')); ?>" alt="metro" title="Icon made by Freepik from www.flaticon.com"> Улица 1905 года </span>
                    </div>
...
<?php /**PATH /opt/lampp/htdocs/findsport/resources/views/frontend/arenas.blade.php ENDPATH**/ ?>