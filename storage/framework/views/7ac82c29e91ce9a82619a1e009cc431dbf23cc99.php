      ...
      <div class="card">
        <div class="card-body">
            ...
            <tbody>
              <?php foreach ($posts as $item): ?>
                <tr>
                  ...
                  <?}?>
                  <td>
                      <a href="<?php echo e(route('edit_product',['type'=>$type,'id'=>$item->id])); ?>" 
                         class="btn btn-warning">
                            Edit
                      </a>
                  </td>
                  <td>
                    <a href="<?php echo e(route('delete_product',['type'=>$type,'id'=>$item->id])); ?>"
          ...
          <div style="margin-top:15px;">
            <a class="btn btn-success " href="<?php echo e(route('create_product',$type)); ?>">New <?php echo e($page); ?></a>
          </div>
        </div>
      </div>
    </div>
...
</script><?php /**PATH /opt/lampp/htdocs/maxs/v2/resources/views/admin/product/index.blade.php ENDPATH**/ ?>