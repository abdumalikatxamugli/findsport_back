					...
					<div class="row" id="collection">
						...
						<?php foreach ($media as $m): ?>
							<div class="col-md-2 img-box">
								...
								>
								<img src="<?php echo e(route('img', explode('/',$m->path))); ?>" 
								alt=""
								>
							</div>
						<?php endforeach ?>
...
<script type="text/javascript">
	...
	function submit_collection(event){
		...
		fetch("<?php echo e(route('media_map')); ?>",{
			method:'POST',
...
function uploadFile(file, i) {
  var url = "<?php echo e(route('upload_media')); ?>"
...
<?php /**PATH /opt/lampp/htdocs/findsport/resources/views/admin/media_lib/list.blade.php ENDPATH**/ ?>