            ...
            <tbody>
              <?php foreach ($posts as $item): ?>
                <tr>
                  ...
                  <td><a class="btn btn-warning" href="<?php echo e(route('one_order',$item->id)); ?>">Get it</a></td>
                </tr>
              <?php endforeach ?>
            </tbody>
            <tfoot>
...
</script><?php /**PATH /opt/lampp/htdocs/maxs/v2/resources/views/admin/orders_manager/index.blade.php ENDPATH**/ ?>