				...
				<div class="card-header p-0 pt-1 border-bottom-0">
	              ...
	              <?}else{?>
		            	...
		            	<select class="custom-select" name="ctype">
		              			<option value="tosell">Selling</option>
		              		    <option value="tolend">Lending</option>
		              	</select>
		            <?}?>
	              <div class="form-group">
...
</script><?php /**PATH /opt/lampp/htdocs/maxs/v2/resources/views/admin/category/create.blade.php ENDPATH**/ ?>